...
export default function MarkerSvg(props: Props) {
  return (
    <svg className={props.className} width="36" height="52" viewBox="0 0 36 52" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd" clip-rule="evenodd" d="M18 34C18.5523 34 19 34.4477 19 35V46.5C19 47.0523 18.5523 47.5 18 47.5C17.4477 47.5 17 47.0523 17 46.5V35C17 34.4477 17.4477 34 18 34Z" fill={props.color}/>
