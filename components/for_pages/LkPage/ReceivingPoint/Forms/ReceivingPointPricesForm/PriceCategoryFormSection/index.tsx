import styles from 'components/for_pages/LkPage/ReceivingPoint/Forms/ReceivingPointPricesForm/PriceCategoryFormSection/index.module.scss'
...
export default function PriceCategoryFormSection(props: Props) {
  ...
  console.log('FormValues', props.values)
  return (
