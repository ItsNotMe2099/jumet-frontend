  ...
  return (
    <DealStepResultCardLayout title={'Результат взвешивания'} date={deal.weighingAt} initialOpen={props.initialOpen ?? false} >
      <div className={styles.root}>
        ...
        {!!deal.bonus && <DescField label={'Бонус продавцу от Ломмаркет'} value={Formatter.formatPrice(deal.bonus)}/>}
        ...
        {!!deal.total && <DescField label={'К оплате'} value={<div className={styles.total}>{Formatter.formatPrice(deal.total)}</div>}/>}
