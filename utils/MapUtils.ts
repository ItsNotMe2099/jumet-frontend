import {GenericBounds} from '@yandex/ymaps3-types/common/types/bounds'
...
export default class MapUtils {
  ...
  static getPopupPosition (
    ...
    const {
      ...
      leftC,
      bottomC,
    } = MapUtils.getMapElementsData(mapElement, popupElement, markerElement)
